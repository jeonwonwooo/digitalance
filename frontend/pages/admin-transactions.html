...
<html lang="en">
  <head>
    ...
    <title>Transactions Management | Digitalance</title>
    ...
    <div class="app">
      <aside class="sidebar">
        ...
        <nav class="nav nav-scroll">
          ...
          <button class="nav-item active"><i class="ri-bank-card-line"></i> Transactions</button>
      ...
      <main class="main">
        <header class="main-header">
          <div class="search-wrap">
            ...
            <input class="search-input" id="trx-search-input" type="text" placeholder="Cari ID Transaksi atau Order ID..." />
          </div>

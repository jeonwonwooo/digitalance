...
<html lang="en">
  <head>
    ...
    <title>Review Management | Digitalance</title>
    ...
    <div class="app">
      <aside class="sidebar">
        ...
        <nav class="nav nav-scroll">
          ...
          <button class="nav-item active"><i class="ri-star-line"></i> Reviews</button>
      ...
      <main class="main">
        <header class="main-header">
          <div class="search-wrap">
            ...
            <input class="search-input" id="review-search-input" type="text" placeholder="Cari ID Review, Order ID, atau komentar..." />
          </div>
